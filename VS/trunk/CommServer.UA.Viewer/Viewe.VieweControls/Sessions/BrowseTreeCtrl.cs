...
{
    public partial class BrowseTreeCtrl : CAS.OPC.UA.Viewer.Client.Controls.BaseTreeCtrl
    {
        #region Contructors
        ...
        protected override void EnableMenuItems(TreeNode clickedNode)
        {
            ...
            if (clickedNode != null)
            {
                ...
                if (reference != null)
                {
                    ...
                    INode node = m_browser.Session.ReadNode((NodeId)reference.NodeId);
                    ...
                    if (accessLevel != 0)
                    {
                        ...
                        HistoryUpdateMI.Visible = false; //TODO It used to be true in SDK 1.318
                        ...
                        {
                          HistoryUpdateMI.Enabled = false; //TODO It used to be true in SDK 1.318
                        }
                    }
        ...
        internal void BrowseMI_Click(object sender, EventArgs e)
        {
            try
            {
                if (NodesTV.SelectedNode == null)
