...
{
    public partial class DataChangeNotificationListCtrl : CAS.OPC.UA.Viewer.Client.Controls.BaseListCtrl
    {
        ...
        protected override void UpdateItem(ListViewItem listItem, object item)
        {
            ...
            {
                listItem.SubItems[3].Text = String.Format("{0}", change.Value.StatusCode);
            }
